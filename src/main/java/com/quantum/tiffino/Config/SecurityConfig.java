        ...
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers("/api/admin/register").hasRole("SUPERADMIN")
                              ...
                              //  .requestMatchers("/api/admin/login").hasAnyRole("SUPERADMIN", "ADMIN")
...
//                        .requestMatchers("/menus/create").permitAll()
                              //  .requestMatchers().permitAll()
                                .requestMatchers("/orders/{orderId}/assign-delivery").permitAll()
                               ...
                               // .requestMatchers("/orders").permitAll()
                                ...
                                .requestMatchers("/api/tickets/{ticketId}").permitAll()
                                .requestMatchers("/api/tickets/{ticketId}/status").permitAll()
                                ...
                                .requestMatchers("/api/admin/credential").permitAll()
                                .requestMatchers("/api/delivery-persons/register","/api/delivery-persons/login","/api/delivery-persons","/api/delivery-persons/{id}/available/{status}").permitAll()
